...
class ProductController extends Controller {
    ...
    protected const MODEL_ID = 3;

    public function index(){
        $input = \request()->all();
        $data = ProductLogic::getPageList($input);
        $pageBar = new PageBar();
    ...
    public function save(){
        ...
        $tmpId = ProductLogic::save($id, $data);
        if($id == 0){
            $id = $tmpId;
        }
    ...
    public function setStatus(){
        $id = I('id', 0);
        $state = I('state', 0);
        ProductLogic::setState($id, $state);
        $this->success();
    }
    ...
    public function setField(){
        ...
        $field = I('field');
        $value = I('value', 0);
        ProductLogic::setField($id, $field, $value);
        $this->success();
    }
    ...
    public function move(){
        ...
        ProductLogic::move($ids, $class_id);
        $this->success();
    }
