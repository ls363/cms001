...
class JobController extends Controller {
    ...
    protected const MODEL_ID = 5;

    public function index(){
        $input = \request()->all();
        $data = JobLogic::getPageList($input);
        $pageBar = new PageBar();
    ...
    public function setField(){
        ...
        $field = I('field');
        $value = I('value', 0);
        JobLogic::setField($id, $field, $value);
        $this->success();
    }
