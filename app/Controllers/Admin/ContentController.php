...
class ContentController extends Controller {
    ...
    protected const MODEL_ID = 0;

    public function index(){
        $input = \request()->all();
        $data = ContentLogic::getPageList($input);
        $pageBar = new PageBar();
    ...
    public function save(){
        ...
        $tmpId = ContentLogic::save($id, $data);
        if($id == 0){
            $id = $tmpId;
        }
    ...
    public function setStatus(){
        $id = I('id', 0);
        $state = I('state', 0);
        ContentLogic::setState($id, $state);
        $this->success();
    }
    ...
    public function setField(){
        ...
        $field = I('field');
        $value = I('value', 0);
        ContentLogic::setField($id, $field, $value);
        $this->success();
    }
    ...
    public function move(){
        ...
        ContentLogic::move($ids, $class_id);
        $this->success();
    }
