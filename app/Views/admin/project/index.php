...
<div class="layui-inline">
    <button class="layui-btn layui-btn-sm layui-btn-normal add-btn-right" data-desc="添加案例" data-url="{{url('info')}}"><i class="layui-icon">&#xe654;</i></button>
    ...
    <tr>
        ...
        <td>
            <div class="layui-inline">
                ...
                {/if}
                <button class="layui-btn layui-btn-xs layui-btn-normal edit-btn-right" data-id="{$v['id']}" data-h="500" data-desc="修改案例" data-url="{{url('info', ['id' => $v['id']])}}">修改</button>
