...
<div class="page_title">{if $id > 0}修改{else}添加{/if}产品</div>
...
<div class="layui-tab" lay-filter="tabDemo">
    ...
    <!--扩展字段-->
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                                                <input type="radio" {if isset($info['color']) && $info['color'] == '红色'}checked{/if} name="color" value="红色" title="红色" >
                                <input type="radio" {if isset($info['color']) && $info['color'] == '蓝色'}checked{/if} name="color" value="蓝色" title="蓝色" >
                                <input type="radio" {if isset($info['color']) && $info['color'] == '黄色'}checked{/if} name="color" value="黄色" title="黄色" >
                                <input type="radio" {if isset($info['color']) && $info['color'] == '紫色'}checked{/if} name="color" value="紫色" title="紫色" >
                                <input type="radio" {if isset($info['color']) && $info['color'] == '黑色'}checked{/if} name="color" value="黑色" title="黑色" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                                                <input type="radio" {if isset($info['type']) && $info['type'] == '基础版'}checked{/if} name="type" value="基础版" title="基础版" >
                                <input type="radio" {if isset($info['type']) && $info['type'] == '专业版'}checked{/if} name="type" value="专业版" title="专业版" >
                                <input type="radio" {if isset($info['type']) && $info['type'] == '旗舰版'}checked{/if} name="type" value="旗舰版" title="旗舰版" >
