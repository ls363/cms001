...
class ProductLogic
{
    ...
    {
        return Product::query()->orderBy('sort', 'asc')->get();
    }
    ...
    public static function setState(int $id, int $state){
        ...
        return Product::where('id', $id)->update(['state' => $state]);
    }
    ...
    public static function setField(int $id, string $field, int $state){
        ...
        return Product::where('id', $id)->update([$field => $state]);
    }
    ...
    {
        try {
            return Product::query()->whereIn('id', $ids)->update(['class_id' => $class_id]);
        } catch (\Exception $e) {
            return false;
        }
    }
